...
ui <- shinyUI(fluidPage(
  ...
  navbarPage(
    ...
    tabPanel(
      "Alex: Alcohol Use Disorder in the United States 2015-2016",
      sidebarLayout(
        sidebarPanel(
          selectInput(
            "alcoholUseDisorderAgeFilter",
        ...
        mainPanel(plotlyOutput("alcoholUseDisorderPlot"))
      )
    ),
    tabPanel(
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          sliderInput(
            "yearAlch",
            h3("Year"),
            min = min(tax_data$year),
            max = max(tax_data$year),
            value = min(tax_data$year),
            step = 1,
            sep = "",
            ticks = F
          ),
        ...
        mainPanel(
          ...
          tags$div(
            class = "alchText",
            tags$p(
              "This plot displays the alcohol taxation in the US by state, year, and by
            ...
            tags$p(
              "An issue with the tax data is that the taxes are applied in gallons of
            ...
            tags$p(
              "Throughout the last four years, not much has changed. Besides a few changes
    ...
    tabPanel(
      ...
      sidebarLayout(
        ...
        mainPanel(
          ...
          tags$br(),
          tags$div(
            class = "regResultsText",
            tags$h3("Results"),
            tags$p(
              "To analyze the relationship between we performed simple linear regressions.
            ...
            tags$p(
              "As seen above, both naive regressions displayed that there is no statistically
          ...
          tags$div(
            class = "regConclusionText",
            tags$h3("Conclusion"),
            tags$p(
              "In conclusion, if states are looking to combat alcohol abuse prevalence, attempts through taxation
            ...
            tags$p(
              "The Seattle sugary beverage tax is a great example of taxation policies attempting to address public health.
